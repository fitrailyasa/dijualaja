                    ...
                    <tbody>
                        @foreach ($kategoris as $kategori)
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/img') }}/{{ $kategori->gambar_kategori }}" width="50"
                                        height="50"></td>
                                <td>{{ $kategori->nama_kategori ?? 'Data Kosong' }}</td>
                                <td class="manage-row">
                                    ...
                                    @elseif (auth()->user()->roles_id == 2)
                                        <a href="{{ route('seller.kategori.show', $kategori->id) }}"
                                            class="btn-sm btn-success">Detail</a>
                                        <a href="{{ route('seller.kategori.edit', $kategori->id) }}"
                                            class="btn-sm btn-warning">Edit</a>
                                        <!-- Button trigger modal -->
                                        <a role="button" class="btn-sm btn-danger delete-button" data-bs-toggle="modal"
                                            data-bs-target=".bd-example-modal-sm{{ $kategori->id }}">
                                        ...
                                        <div class="modal fade bd-example-modal-sm{{ $kategori->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('seller.kategori.destroy', $kategori->id) }}"
                                                            method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                            <input type="submit" class="btn btn-danger light"
