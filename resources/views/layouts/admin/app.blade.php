...
<head>
    ...
    <title>{{ auth()->user()->nama }} | @yield('title')</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <img class="animation__shake" src="{{ asset('assets/img/logo.png') }}" alt="AdminLTELogo" width="60">
        ...
        <aside class="main-sidebar elevation-4 bg-success bg-gradient">
            <!-- Brand Logo -->
            <a href="#" class="brand-link px-3">
                ...
                <span class="brand-text font-weight-normal text-white">DIJUALAJA</span>
            </a>
        ...
        <!-- /.content-wrapper -->
        <footer class="px-3 py-2 d-block d-lg-none border-top text-white mt-3 fixed-bottom"
            style="background-color: #117b46">
            <div class="container">
                <div class="d-flex">
