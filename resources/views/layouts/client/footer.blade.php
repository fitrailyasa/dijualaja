...
<div class="navbar p-0 d-lg-block d-xl-none" id="mobile-footer-bar">
    <ul class="container-fluid footer-bar">
        ...
        <li>
            <a href="/game-home">
                <svg class="" width="24" height="24" viewBox="0 0 32 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path id="icon-navbar" fill-rule="evenodd" clip-rule="evenodd"
        ...
        @if (auth()->user()->roles_id != 9)
            <li>
                <a href="/biodata">
                    <svg width="26" height="24" viewBox="0 0 36 44" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path id="icon-navbar" fill-rule="evenodd" clip-rule="evenodd"
                            d="M29.4702 11.7973C29.4702 18.1608 24.368 23.2634 17.9999 23.2634C11.6341 23.2634 6.52964 18.1608 6.52964 11.7973C6.52964 5.43372 11.6341 0.333336 17.9999 0.333336C24.368 0.333336 29.4702 5.43372 29.4702 11.7973ZM17.9998 43.6667C8.60165 43.6667 0.666504 42.1392 0.666504 36.2458C0.666504 30.3502 8.6515 28.8769 17.9998 28.8769C27.4002 28.8769 35.3332 30.4044 35.3332 36.2978C35.3332 42.1933 27.3482 43.6667 17.9998 43.6667Z"
                            fill="white" />
                    </svg>
                    Profile
                </a>
